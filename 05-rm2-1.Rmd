...
```{r img-dialog, echo=FALSE, fig.cap=".Rmd dialog box"}

knitr::include_graphics("images/rmd_dialog.png")
...
```{r img-headers, echo=FALSE, fig.cap=".Rmd header"}

knitr::include_graphics("images/rmd_header.png")
...
```{r img-default-chunk, echo=FALSE, fig.cap="Default chunk"}

knitr::include_graphics("images/rmd_defaultchunk.png")
...
```{r img-chunk1, echo=FALSE, fig.cap="Chunk 1"}

knitr::include_graphics("images/rmd_chunk1.png")
...
```{r img-knitting, echo=FALSE, fig.cap="Knitting"}
...
```{r img-summary, echo=FALSE, fig.cap="Displaying code"}

knitr::include_graphics("images/rmd_summary.png")
...
```{r img-summary2, echo=FALSE, fig.cap="Code and output"}

knitr::include_graphics("images/rmd_summary2.png")
...
```{r img-hide, echo=FALSE, fig.cap="Hiding output from knitted output"}

knitr::include_graphics("images/rmd_hide.png")
...
```{r img-echo, echo=FALSE, fig.cap="Hiding code from knitted output"}

knitr::include_graphics("images/rmd_echo.png")
...
```{r img-eval, echo=FALSE, fig.cap="Stopping code evaluation"}

knitr::include_graphics("images/rmd_eval.png")
...
```{r img-bold, echo=FALSE, fig.cap="Bold formatting"}

knitr::include_graphics("images/rmd_bold.png")
...
```{r img-hashtag, echo=FALSE, fig.cap="Hashtag headings"}

knitr::include_graphics("images/rmd_hashtag.png")
...
1. You want to show the code you are running in your analysis but not show the output as this would be too much to display. Note that you want the code to run. Type in the box (e.g. `rule = "set"`) how you would set the `results` rule to do this? `r fitb("results = \"hide\"", width = 20, ignore_ws = TRUE)`

2. You create a plot of happiness versus neuroticism scores but you want to hide the code and only show the output. How can you do this? `r mcq(c("echo = TRUE", "include = FALSE", "code = HIDE", answer = "echo = FALSE"))`

`r hide("Explain these answers")`
```{r, echo = FALSE, results='asis'}

cat("The first answer should be results = \"hide\" as you want to show the code and run the code but not necessarily show the output of the code. Remember that \"hide\" needs to be in quotation marks.
...
3. True or False: writing `echo = TRUE` has the same effect on the output of a code as if you had no echo rule at all: `r torf(TRUE)`
...
4. True or False: there is no difference between the rules `results = "hide"` and `eval = FALSE` as they both hide the output: `r torf(FALSE)`

`r hide("Explain this")`
```{r, echo = FALSE, results='asis'}
cat("In the first rule, `results = \"hide\"`, the code is evaluated and results are produced but the output is hidden. In the second rule, `eval = FALSE`, the code is not evaluated and therefore no results or output has been produced. If you need your output for a later part of the code then you would use the `results` rule. If you don't need the output and just want to show the code as an example then you would use the `eval` rule.")
```
`r unhide()`  

<br>

5. If \* puts words into italics, and \*\* puts words into bold, type in the box what might you put before (and technically after) a word to put it into italics with bold? `r fitb("***")`

6. True or False: The **more** '#'s you include, the **smaller** the header is: `r torf(TRUE)`  
...
```{r abil_hist, warning=FALSE, message=FALSE, fig.cap="Histogram of Abil"}
...
```{r qq_abil, fig.cap="QQ-plot for Abil"}
qqPlot(x = mh$Abil)
```
